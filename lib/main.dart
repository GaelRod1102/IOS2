...
class PaginaInicio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bordes en la app de Gael"),
        centerTitle: true,
      ), //fin appbar
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.indigo,
                  image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/GaelRod1102/Mis_imagenes/main/IMG_5080.JPG"), alignment: Alignment.topCenter),
                  border: Border(
                    top: BorderSide(
